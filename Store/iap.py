"""Quiver Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.quiver.pro"
NAME = "Quiver Pro"
PRICE = "3.99"
DESCRIPTION = "Printed true-size tape, more setups, drop chart."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free: the arrow build sheet (weight, FOC, kinetic energy, "
    "spine), the bow and speed page and the fitted sight marks are free forever. Pro unlocks the true-size "
    "printable sight tape (PDF share), more than one bow setup, and the drop and drift chart. To see the "
    "paywall: open the Sight tape tab and tap \"Print the tape at true size\", or tap the frosted drop chart "
    "on the Bow tab, or tap the setup name at the top right of any page and choose New setup. Restore "
    "purchase is on the paywall and on the Quiver Pro card at the bottom of the Sight tape tab."
)
